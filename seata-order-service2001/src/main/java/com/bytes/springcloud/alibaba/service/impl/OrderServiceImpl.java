...
import com.bytes.springcloud.alibaba.dao.OrderDao;
import com.bytes.springcloud.alibaba.domain.Order;
import com.bytes.springcloud.alibaba.service.AccountService;
...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	@GlobalTransactional(name = "fsp-create-order", rollbackFor = Exception.class)//name:全局唯一即可。rollbackFor：指定那些异常触发事务回滚
